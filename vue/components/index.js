...
import { RichTextareaPlatforme } from "./ui/rich-textarea-platforme/rich-textarea-platforme.vue";
...
const install = Vue => {
    ...
    Vue.component("rich-textarea-platforme", RichTextareaPlatforme);
