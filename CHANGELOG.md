...
* Add method to replace filter and specify operator on `listing` - [#240](https://github.com/ripe-tech/ripe-pulse/issues/240)
* Add method to remove filters on `listing` - [#240](https://github.com/ripe-tech/ripe-pulse/issues/240)
